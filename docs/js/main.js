        ...
        execute: function () {
            b2EdgeShape = (function (_super) {
                ...
                function b2EdgeShape() {
                    var _this = _super.call(this, 1, b2Settings_8.b2_polygonRadius) || this;
        ...
        execute: function () {
            b2ChainShape = (function (_super) {
                ...
                function b2ChainShape() {
                    var _this = _super.call(this, 3, b2Settings_9.b2_polygonRadius) || this;
                    _this.m_count = 0;
        ...
        execute: function () {
            b2PolygonShape = (function (_super) {
                ...
                function b2PolygonShape() {
                    var _this = _super.call(this, 2, b2Settings_11.b2_polygonRadius) || this;
                    _this.m_centroid = new b2Math_12.b2Vec2(0, 0);
                    _this.m_vertices = b2Math_12.b2Vec2.MakeArray(b2Settings_11.b2_maxPolygonVertices);
                    _this.m_normals = b2Math_12.b2Vec2.MakeArray(b2Settings_11.b2_maxPolygonVertices);
                    _this.m_count = 0;
                    return _this;
                }
        ...
        execute: function () {
            b2VoronoiDiagram = (function () {
                function b2VoronoiDiagram(generatorCapacity) {
                    ...
                    this.m_countY = 0;
                    this.m_diagram = null;
                    this.m_generatorBuffer = b2Settings_25.b2MakeArray(generatorCapacity, function (index) {
        ...
        execute: function () {
            ...
            b2ParticleSystem = (function () {
                ...
                b2ParticleSystem.prototype.SplitParticleGroup = function (group) {
                    ...
                    var nodeBuffer = b2Settings_26.b2MakeArray(particleCount, function (index) {
        ...
        execute: function () {
            ...
            b2ContactFactory = (function () {
                ...
                b2ContactFactory.prototype.AddType = function (createFcn, destroyFcn, type1, type2) {
                    var that = this;
                    var pool = b2Settings_39.b2MakeArray(256, function (i) { return createFcn(that.m_allocator); });
    ...
    return {
        ...
        execute: function () {
            CollisionListener = (function () {
                function CollisionListener(game) {
                    this._game = game;
                }
                CollisionListener.prototype.BeginContact = function (contact) {
                    for (var _i = 0, _a = this._game.enemies; _i < _a.length; _i++) {
                        var enemy = _a[_i];
                        if (contact.GetFixtureA().GetUserData() == enemy && contact.GetFixtureB().GetUserData() == this._game.player
                            ...
                            this._game.app.SwitchScreen(App_1.Screens.END);
                        }
                    }
                };
                CollisionListener.prototype.EndContact = function (contact) {
                ...
                CollisionListener.prototype.BeginContactFixtureParticle = function (system, contact) {
                };
                CollisionListener.prototype.EndContactFixtureParticle = function (system, contact) {
                };
                CollisionListener.prototype.BeginContactParticleParticle = function (system, contact) {
                };
                CollisionListener.prototype.EndContactParticleParticle = function (system, contact) {
                };
                CollisionListener.prototype.PreSolve = function (contact, oldManifold) {
                };
                CollisionListener.prototype.PostSolve = function (contact, impulse) {
                };
...
System.register("Box2DObject", ["Box2D/Box2D"], function (exports_61, context_61) {
    ...
    return {
        ...
        execute: function () {
            Box2DObject = (function () {
                function Box2DObject(world, positionX, positionY, width, height, restitution, isSensor, bodyType) {
                    this.world = world;
                    this.width = width;
                    this.height = height;
                ...
                Box2DObject.prototype.generateBox2DObject = function (width, height) {
                    this.width = width / 2;
                    ...
                    var rectangle = new box2d.b2PolygonShape();
...
System.register("Player", ["Box2D/Box2D", "Box2DObject"], function (exports_62, context_62) {
    ...
    return {
        setters: [
            ...
            function (Box2DObject_1_1) {
                Box2DObject_1 = Box2DObject_1_1;
            }
        ],
        execute: function () {
            Player = (function (_super) {
                __extends(Player, _super);
                function Player(world, canvas, positionX, positionY) {
                    var _this = _super.call(this, world, positionX, positionY, .1, .1, .5, false, 2) || this;
                    _this._horizontalForce = .2;
                    _this._maxHorizontalVelocity = 3;
                    _this._context = canvas.getContext("2d");
                    _this.body.SetFixedRotation(true);
                    return _this;
                }
                Object.defineProperty(Player.prototype, "isMovingLeft", {
                    set: function (isMovingLeft) {
                        this._isMovingLeft = isMovingLeft;
                    },
                    enumerable: true,
                    configurable: true
                });
                Object.defineProperty(Player.prototype, "isMovingRight", {
                    set: function (isMovingRight) {
...
System.register("Block", ["Box2D/Box2D", "Box2DObject"], function (exports_63, context_63) {
    ...
    return {
        setters: [
            ...
            function (Box2DObject_2_1) {
                Box2DObject_2 = Box2DObject_2_1;
            }
        ],
        execute: function () {
            Block = (function (_super) {
                __extends(Block, _super);
                function Block(canvas, world, positionX, positionY, width, height, bodyType) {
                    var _this = _super.call(this, world, positionX, positionY, width, height, 0, false, 0) || this;
...
System.register("Enemy", ["Box2D/Box2D", "Box2DObject"], function (exports_64, context_64) {
    ...
    return {
        setters: [
            ...
            function (Box2DObject_3_1) {
                Box2DObject_3 = Box2DObject_3_1;
            }
        ],
        execute: function () {
            Enemy = (function (_super) {
                __extends(Enemy, _super);
                function Enemy(canvas, world, isMovingLeft) {
                    var _this = _super.call(this, world, 6.25, 0, .5, .5, 0, true, 1) || this;
                    _this._width = .5;
                    _this._height = .5;
                    _this._isMovingLeft = true;
                    _this._horizontalForce = -1;
                    if (!isMovingLeft) {
                        _this.body.SetPosition(new box2d.b2Vec2(-.25, .25));
                        _this._horizontalForce *= -1;
                    }
                    _this._context = canvas.getContext("2d");
                    _this._isMovingLeft = isMovingLeft;
                    _this.body.SetGravityScale(0);
                    return _this;
                }
...
System.register("EnemySpawnManager", ["Enemy"], function (exports_65, context_65) {
    ...
    return {
        ...
        execute: function () {
            EnemySpawnManager = (function () {
                function EnemySpawnManager(game) {
                    this._lastSpawnFrameCount = 0;
                    this._game = game;
                    this._randomFrameCount = this.RandomIntFromInterval(70, 80);
                    this.SpawnEnemy();
                }
                EnemySpawnManager.prototype.Update = function () {
                ...
                EnemySpawnManager.prototype.SpawnEnemy = function () {
                    var isMovingLeft = false;
                    if (Math.random() > .5) {
                        isMovingLeft = true;
                    }
                    console.log(isMovingLeft);
                    this._game.enemies.push(new Enemy_1.Enemy(this._game.canvas, this._game.world, isMovingLeft));
                };
                EnemySpawnManager.prototype.RandomIntFromInterval = function (min, max) {
    ...
    return {
        ...
        execute: function () {
            InputHandler = (function () {
                ...
                InputHandler.prototype.InitializeListeners = function () {
        ...
        execute: function () {
            Score = (function () {
                ...
                Score.prototype.Draw = function () {
                    ...
                    var text = this._time.toString();
                    var width = this._game.mainCanvasContext.measureText(text).width;
                    this._game.mainCanvasContext.fillText(text, (GameScreen_1.GameScreen.canvasWidth / 2) - (width / 2), -200);
...
System.register("Screens/GameScreen", ["CollisionListener", "Player", "Block", "EnemySpawnManager", "InputHandler", "Score", "Box2D/Box2D"], function (exports_68, context_68) {
    ...
    return {
        setters: [
            function (CollisionListener_1_1) {
                CollisionListener_1 = CollisionListener_1_1;
            },
            function (Player_1_1) {
                Player_1 = Player_1_1;
            },
            ...
            function (EnemySpawnManager_1_1) {
                EnemySpawnManager_1 = EnemySpawnManager_1_1;
            },
            function (InputHandler_1_1) {
                InputHandler_1 = InputHandler_1_1;
            },
            function (Score_1_1) {
                Score_1 = Score_1_1;
            },
        ...
        execute: function () {
            GameScreen = (function () {
                function GameScreen(app) {
                    ...
                    this._player = new Player_1.Player(this._world, this._canvas, 2.95, 3);
                    this._floor = new Block_1.Block(this._canvas, this._world, 0, 0, 6, .1, 0);
                    this._wallLeft = new Block_1.Block(this._canvas, this._world, 0, 0, .1, 6, 0);
                    this._wallRight = new Block_1.Block(this._canvas, this._world, 6 - .1, 0, .1, 6, 0);
                    this._world.SetContactListener(new CollisionListener_1.CollisionListener(this));
                    this._inputHandler = new InputHandler_1.InputHandler(this);
                    this._enemySpawnManager = new EnemySpawnManager_1.EnemySpawnManager(this);
                    this._score = new Score_1.Score(this);
                }
                Object.defineProperty(GameScreen.prototype, "app", {
                    get: function () {
                        return this._app;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(GameScreen.prototype, "player", {
                    get: function () {
                        return this._player;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(GameScreen.prototype, "enemies", {
                    get: function () {
                ...
                Object.defineProperty(GameScreen.prototype, "frameCount", {
                    get: function () {
                ...
                Object.defineProperty(GameScreen.prototype, "canvas", {
                    get: function () {
                        return this._canvas;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(GameScreen.prototype, "mainCanvasContext", {
                    get: function () {
                ...
                Object.defineProperty(GameScreen.prototype, "world", {
                    get: function () {
                        return this._world;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(GameScreen.prototype, "floor", {
                    get: function () {
                        return this._floor;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(GameScreen.prototype, "score", {
                    get: function () {
                        return this._score;
                    },
                    enumerable: true,
...
System.register("Screens/StartScreen", ["Screens/GameScreen", "App"], function (exports_69, context_69) {
    ...
    return {
        setters: [
            function (GameScreen_2_1) {
                GameScreen_2 = GameScreen_2_1;
            },
            function (App_2_1) {
                App_2 = App_2_1;
            }
        ...
        execute: function () {
            StartScreen = (function () {
                ...
                StartScreen.prototype.Draw = function () {
                    this._app.mainCanvasContext.clearRect(0, 0, GameScreen_2.GameScreen.canvasWidth, GameScreen_2.GameScreen.canvasHeight);
                    this._app.mainCanvasContext.save();
                    this._app.mainCanvasContext.scale(1, -1);
                    this._app.mainCanvasContext.font = '48px square';
                    var text = "SURVIVE 100 SECONDS";
                    var width = this._app.mainCanvasContext.measureText(text).width;
                    this._app.mainCanvasContext.fillText(text, (GameScreen_2.GameScreen.canvasWidth / 2) - (width / 2), -300);
                    ...
                    this._app.mainCanvasContext.fillText(text, (GameScreen_2.GameScreen.canvasWidth / 2) - (width / 2), -200);
                    this._app.mainCanvasContext.font = '28px square';
                    text = "PRESS SPACEBAR TO BEGIN";
                    width = this._app.mainCanvasContext.measureText(text).width;
                    this._app.mainCanvasContext.fillText(text, (GameScreen_2.GameScreen.canvasWidth / 2) - (width / 2), -100);
        ...
        execute: function () {
            EndScreen = (function () {
                ...
                EndScreen.prototype.Draw = function () {
                    this._app.mainCanvasContext.clearRect(0, 0, GameScreen_3.GameScreen.canvasWidth, GameScreen_3.GameScreen.canvasHeight);
                    this._app.mainCanvasContext.save();
                    this._app.mainCanvasContext.scale(1, -1);
                    this._app.mainCanvasContext.fillStyle = "#000000";
                    this._app.mainCanvasContext.fillRect(0, -GameScreen_3.GameScreen.canvasHeight, GameScreen_3.GameScreen.canvasWidth, GameScreen_3.GameScreen.canvasHeight);
                    this._app.mainCanvasContext.font = '40px square';
                    var text = "GAME OVER";
                    var width = this._app.mainCanvasContext.measureText(text).width;
                    this._app.mainCanvasContext.fillStyle = "#990000";
                    this._app.mainCanvasContext.fillText(text, (GameScreen_3.GameScreen.canvasWidth / 2) - (width / 2), -300);
                    this._app.mainCanvasContext.font = '48px square';
                    text = this._app.gameScreen.score.time.toString();
                    width = this._app.mainCanvasContext.measureText(text).width;
                    this._app.mainCanvasContext.fillStyle = "#990000";
                    this._app.mainCanvasContext.fillText(text, (GameScreen_3.GameScreen.canvasWidth / 2) - (width / 2), -200);
                    this._app.mainCanvasContext.font = '32px square';
                    text = "PRESS 'R' TO RESTART";
                    width = this._app.mainCanvasContext.measureText(text).width;
                    this._app.mainCanvasContext.fillStyle = "#990000";
                    this._app.mainCanvasContext.fillText(text, (GameScreen_3.GameScreen.canvasWidth / 2) - (width / 2), -100);
                    this._app.mainCanvasContext.restore();
                };
                return EndScreen;
            }());
...
System.register("App", ["Screens/StartScreen", "Screens/GameScreen", "Screens/EndScreen"], function (exports_71, context_71) {
    ...
    return {
        setters: [
            function (StartScreen_1_1) {
                StartScreen_1 = StartScreen_1_1;
            },
            function (GameScreen_4_1) {
                GameScreen_4 = GameScreen_4_1;
            },
            function (EndScreen_1_1) {
                EndScreen_1 = EndScreen_1_1;
            }
        ],
        execute: function () {
            (function (Screens) {
            ...
            App = (function () {
                function App() {
                    ...
                    this._canvas = document.getElementById("canvas");
                    this._mainCanvasContext = this._canvas.getContext("2d");
                    this._startScreen = new StartScreen_1.StartScreen(this);
                    this._gameScreen = new GameScreen_4.GameScreen(this);
                ...
                Object.defineProperty(App.prototype, "mainCanvasContext", {
                    get: function () {
                        return this._mainCanvasContext;
                    },
                    enumerable: true,
                ...
                Object.defineProperty(App.prototype, "activeScreen", {
                    get: function () {
                ...
                Object.defineProperty(App.prototype, "gameScreen", {
                    get: function () {
